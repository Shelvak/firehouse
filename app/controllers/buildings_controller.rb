class BuildingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @building.save
        format.html { redirect_to [@intervention, @mobile_intervention.endowment, @mobile_intervention], notice: t('view.buildings.correctly_created') }
        format.json { render json: [@intervention, @mobile_intervention.endowment, @mobile_intervention], status: :created, location: @building }
      else
  ...
  def update
    ...
    respond_to do |format|
      if @building.update_attributes(params[:building])
        format.html { redirect_to [@intervention, @mobile_intervention.endowment, @mobile_intervention], notice: t('view.buildings.correctly_updated') }
        format.json { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to [@intervention, @mobile_intervention.endowment, @mobile_intervention] }
      format.json { head :ok }
    end
  end
